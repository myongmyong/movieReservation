...
public class MovieVo {
	...
	public String getMovieShowingYn() {
		return movieShowingYn;
	}
	public void setMovieShowingYn(String movieShowingYn) {
		this.movieShowingYn = movieShowingYn;
	}
